...
const menuLinks = [
  {
    title: 'MENTORIA ENGAJA<span style="display: inline-block; margin-left: 1px; font-size: 20px; line-height: 0; font-family: \'Associate Sans Medium, Helvetica, sans-serif\';">+</span> INSTAGRAM',
    category: 'Menu',
    target: '_blank',
    url: {
